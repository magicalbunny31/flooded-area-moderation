...
export default class Commands {
   ...
   async #getPayload() {
         ...
         case `chat-input application commands`:
            payload.components.push(
               new Discord.ContainerBuilder()
                  .setAccentColor(colours.flooded_area_moderation)
            ...
            payload.flags.push(Discord.MessageFlags.IsComponentsV2);
      ...
      // add submenu select menus
      if (this.#selectedMenu.startsWith(`text-based commands`))
         payload.components.push(
            new Discord.ActionRowBuilder()
               .setComponents(
                  new Discord.StringSelectMenuBuilder()
      ...
      if (this.#selectedMenu.startsWith(`text-based commands:text-based command aliases`))
         payload.components.push(
            new Discord.ActionRowBuilder()
               .setComponents(
                  new Discord.StringSelectMenuBuilder()
